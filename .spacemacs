...
you should place your code here."
  ...
  (setq-default js-indent-level 2)
	...
	(setq aspell-program-name "/usr/local/bin/aspell")
	...
	(setq create-lockfiles nil) ;; TODO remove this line once the recentf bug with lockfiles is resolved
...
(defun configure-org-mode ()
	;; set default to file to Dropbox
	(setq org-default-notes-file "~/Dropbox/org/notes.org")

	;; configure capture templates for Life and Work
  (setq org-capture-templates
		'(
			 ("t"
				 "Todo list item"
				 entry
				 (file+olp org-default-notes-file "Life" "Tasks")
				 "* TODO %?\n %i\n %a")
			 ("w" "Templates for marking stuff for work")
			 ("wt"
				 "Todo list item"
				 entry
				 (file+olp org-default-notes-file "Work" "Tasks")
				 "* TODO %?\n %i\n %a")
			 ("wj"
				 "Create Jira Ticket"
				 entry
				 (file+olp org-default-notes-file "Work" "Jira Tickets")
				 "* TODO [CREATE_TICKET] %?\n %i\n %a")
			 )
    )
	...
	'(lambda ()
			...
			(spacemacs/set-leader-keys-for-major-mode 'org-mode "ok" 'org-table-move-single-cell-up)
			(spacemacs/set-leader-keys-for-major-mode 'org-mode "oj" 'org-table-move-single-cell-down)
			(spacemacs/set-leader-keys-for-major-mode 'org-mode "oh" 'org-table-move-single-cell-left)
			(spacemacs/set-leader-keys-for-major-mode 'org-mode "ol" 'org-table-move-single-cell-right)
		))
